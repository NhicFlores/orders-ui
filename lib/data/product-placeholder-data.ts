...
export const shapeOptions: Shape[] = [
  ...
  },
  {
    ...
    required_dimensions: {
      base: { label: "Base", value: "" },
      height: { label: "Height", value: "" },
      left_sub_height: { label: "Left Sub Height", value: "" },
      right_sub_height: { label: "Right Sub Height", value: "" },
    },
    thickness_options: [],
    tint_types: [],
    options_types: [],
  ...
  },
  {
    ...
    required_dimensions: {
      base: { label: "Base", value: "" },
      height: { label: "Height", value: "" },
      sub_height: { label: "Sub Height", value: "" },
      radius: { label: "Radius", value: "" },
      offset: { label: "Offset", value: "" },
    },
    thickness_options: [],
  ...
  },
  {
    ...
    required_dimensions: {
      base: { label: "Base", value: "" },
      height: { label: "Height", value: "" },
      left_projection: { label: "Left Projection", value: "" },
      right_projection: { label: "Right Projection", value: "" },
    },
    thickness_options: [],
    tint_types: [],
    options_types: [],
  },
  {
    ...
    required_dimensions: {
      base: { label: "Base", value: "" },
      height: { label: "Height", value: "" },
      edge_length: { label: "Edge Length", value: "" },
    },
    thickness_options: [],
    tint_types: [],
    options_types: [],
